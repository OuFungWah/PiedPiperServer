...
public class PictureUtils {
     ...
     */
    public static String savePic(String base64, String accountName, String fileName) throws FileAlreadyExistsException, IOException {
        ...
        File file = new File(FILE_PATH + accountName + "/" + fileName + ".png");
        Log.d(TAG, file.getAbsolutePath());
        if (file.exists()) {
            throw new FileAlreadyExistsException(dir.getAbsolutePath() + "/" + fileName + ".png");
        } else {
        ...
        return SERVER + accountName + "/" + fileName + ".png";
    }
